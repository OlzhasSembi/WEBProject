...
@section('content')
    ...
    @foreach($data as $task)
        <div class="alert alert-info">
            ...
            <a style="color: #0066c0; font-family: 'Barlow Condensed'" href="{{ route('task-data-one', $task->id) }}"><button style="background-color: #0066c0; font-family: 'Barlow Condensed'" class="btn btn-warning">More</button></a>
        </div>
    @endforeach
@endsection
