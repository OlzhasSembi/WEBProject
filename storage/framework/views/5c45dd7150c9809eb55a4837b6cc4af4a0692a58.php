...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('task-update-submit-done', $data->id)); ?>" method="post">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.basic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\trello\resources\views/update-taskDone.blade.php ENDPATH**/ ?>