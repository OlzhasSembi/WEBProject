...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="alert alert-info">
            ...
            <a style="color: #0066c0; font-family: 'Barlow Condensed'" href="<?php echo e(route('task-data-one-done', $task->id)); ?>"><button style="background-color: #0066c0; font-family: 'Barlow Condensed'" class="btn btn-warning">More</button></a>
        </div>
